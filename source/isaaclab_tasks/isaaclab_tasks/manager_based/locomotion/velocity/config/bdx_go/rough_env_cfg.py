...
# Pre-defined configs
##
from isaaclab_assets import BDX_GO_CFG  # isort: skip


@configclass
class BDX_GoRoughRewards(RewardsCfg):
...
@configclass
class BDX_GoRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    """BDX_Go rough environment configuration."""

    rewards: BDX_GoRoughRewards = BDX_GoRoughRewards()

    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # Scene
        self.scene.robot = BDX_GO_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class BDX_GoRoughEnvCfg_PLAY(BDX_GoRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
