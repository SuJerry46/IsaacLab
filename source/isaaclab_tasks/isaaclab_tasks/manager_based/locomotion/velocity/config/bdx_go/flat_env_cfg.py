...
@configclass
class BDX_GoRewards(RewardsCfg):
...
@configclass
class BDX_GoFlatEnvCfg(LocomotionVelocityRoughEnvCfg):
    """BDX_Go flat environment configuration."""

    rewards: BDX_GoRewards = BDX_GoRewards()
