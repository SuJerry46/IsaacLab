...
from .pickplace_g1_inspire_mimic_env import PickPlaceG1InspireMimicEnv
from .pickplace_g1_inspire_mimic_env_cfg import PickPlaceG1InspireMimicEnvCfg
from .pickplace_g1_inspire_waist_enabled_mimic_env_cfg import PickPlaceG1InspireWaistEnabledMimicEnvCfg
...
gym.register(
    id="Isaac-PickPlace-G1-InspireFTP-Abs-Mimic-v0",
    entry_point="isaaclab_mimic.envs.pinocchio_envs:PickPlaceG1InspireMimicEnv",
    kwargs={
        "env_cfg_entry_point": pickplace_g1_inspire_mimic_env_cfg.PickPlaceG1InspireMimicEnvCfg,
    },
    disable_env_checker=True,
)

gym.register(
    id="Isaac-PickPlace-G1-InspireFTP-WaistEnabled-Abs-Mimic-v0",
    entry_point="isaaclab_mimic.envs.pinocchio_envs:PickPlaceG1InspireMimicEnv",
    kwargs={
        "env_cfg_entry_point": pickplace_g1_inspire_waist_enabled_mimic_env_cfg.PickPlaceG1InspireWaistEnabledMimicEnvCfg,
    },
    disable_env_checker=True,
)