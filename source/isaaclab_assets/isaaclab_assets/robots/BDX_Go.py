...
* :obj:`BDX_GO_CFG`: The BDX_Go robot with implicit Actuator model
...
# from isaaclab.utils.assets import ISAACLAB_NUCLEUS_DIR  # Unused import

##
# Configuration
##

BDX_GO_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        # usd_path=f"{ISAACLAB_NUCLEUS_DIR}/Robots/Disney/BDX/BDX.usd",
        usd_path=f"{ISAACLAB_ASSETS_DATA_DIR}/Robots/BDX_Go/bdx.usd",
...
"""Configuration for the Disney BDX_Go robot with implicit actuator model."""
